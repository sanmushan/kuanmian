 ...
 */
public class NoodlesSerialReceiver {

    private static NoodlesSerialReceiver sInstance;

    public static NoodlesSerialReceiver getIns() {
        if (sInstance == null) {
            synchronized (NoodlesSerialReceiver.class) {
                if (sInstance == null) {
                    sInstance = new NoodlesSerialReceiver();
                }
            }
        }
        return sInstance;
